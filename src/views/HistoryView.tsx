  ...
  return (
    <div style={{ display: 'flex', height: '100%' }}>
      {contextMenu && (
        <div
          ...
          style={{
            ...
            background: '#1c1814', border: '1px solid #2a2218',
        ...
        >
          ...
          <div style={{ height: '1px', background: '#2a2218', margin: '2px 0' }} />
          <button
      ...
      <div style={{
        ...
        <div style={{ padding: '28px 24px 16px', borderBottom: '1px solid #2a2218' }}>
          ...
          {loading ? (
            ...
            return (
              <div
                ...
                style={{
                  padding: '16px 24px', borderBottom: '1px solid #2a2218',
                  cursor: 'pointer',
                  background: selected === s.id ? 'rgba(245,158,11,0.08)' : 'transparent',
                  borderLeft: selected === s.id ? '3px solid #f59e0b' : '3px solid transparent',
                  transition: 'all 0.15s',
                }}
              >
                <div style={{ fontSize: '14px', fontWeight: 600, marginBottom: '4px', color: selected === s.id ? '#fde68a' : '#e5e5e5' }}>
        ...
        return (
          <div style={{ flex: 1, overflowY: 'auto', padding: '28px', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: '6px' }}>
              <input
                ...
                style={{
                  ...
                  background: 'transparent', border: 'none', borderBottom: '1px solid #2a2218',
                  ...
                  {utterances.map((u, i) => {
                    ...
                    return (
                      <div
                        ...
                        style={{ fontSize: '12px', color: '#aaa', padding: '5px 0', cursor: 'pointer', lineHeight: '1.5', borderBottom: '1px solid #2a2218', display: 'flex', gap: '8px' }}
                        onMouseEnter={e => (e.currentTarget.style.color = '#fde68a')}
                        onMouseLeave={e => (e.currentTarget.style.color = '#aaa')}
                      >
                        <span style={{ color: '#f59e0b', fontWeight: 600, flexShrink: 0 }}>{displayName}:</span>
                        <span>{u.text}</span>
                      </div>
                    );
                  })}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {speakers.map(code => (
                    <div key={code} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <span style={{ fontSize: '12px', color: '#f59e0b', fontWeight: 600, minWidth: '80px' }}>
            ...
            <Section title="Dışa Aktar">
                ...
                {(['txt', 'md', 'pdf', 'docx'] as ExportFormat[]).map(fmt => (
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${exportFormat === fmt ? '#f59e0b' : '#2a2218'}`,
                      background: exportFormat === fmt ? 'rgba(245,158,11,0.15)' : 'transparent',
                      color: exportFormat === fmt ? '#fde68a' : '#666',
              ...
              {exportPath && (
                <div style={{ fontSize: '11px', color: '#f59e0b', marginTop: '8px', wordBreak: 'break-all' }}>
                  ✅ {exportPath}
                </div>
              )}
            </Section>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '24px', paddingTop: '16px', borderTop: '1px solid #2a2218' }}>
              <button
                onClick={handleSave}
                disabled={saving}
                style={{
                  padding: '8px 20px', borderRadius: '8px', border: 'none',
                  background: saved ? '#059669' : '#f59e0b', color: '#fff',
              ...
              <button
                ...
                style={{
                  ...
                  background: 'none', border: '1px solid #2a2218', color: '#a1a1aa',
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: '20px' }}>
      ...
      <div style={{ background: '#120f0b', borderRadius: '10px', padding: '16px', border: '1px solid #222' }}>
        {children}
      </div>
    </div>
  );
