  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '720px', width: '100%' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: popular ? 'rgba(245,158,11,.12)' : '#111',
                  border: popular ? '1.5px solid #f59e0b' : '1px solid #222',
                  position: 'relative',
                }}
              >
                {popular && (
                ...
                <button
                  ...
                  style={{
                    ...
                    background: popular ? '#f59e0b' : '#1e1e1e',
                    color: '#fff', fontSize: '12px', fontWeight: 600, cursor: 'pointer',
                    border: popular ? 'none' : '1px solid #2a2218',
                  }}
                >
                  {t.license.buy}
                </button>
        ...
        {/* Activation */}
        <div style={{
          background: '#120f0b', borderRadius: '14px', padding: '24px', border: '1px solid #222',
        }}>
